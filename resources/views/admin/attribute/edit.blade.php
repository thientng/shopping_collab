      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="card card-primary card-outline">
            <form action="{{ route('attributes.update',['id' => $attribute->id]) }}" method="post" enctype="multipart/form-data"> {{-- thêm enctype="multipart/form-data" để có thể up được nhiều ảnh một lúc --}}
              @csrf
                            ...
                            <div class="post-value">
                              <div class="form-group">
                                @if ($nameType == 'color')
                                  ...
                                  <input type="color" name="value" class="form-control form-control-color" id="exampleColorInput" value="{{ $attribute->value }}" title="Choose your color">
                                @else
                                  <label for="exampleColorInput" class="form-label">Nhập kích cỡ</label>
                                  <input type="text" name="value" class="form-control form-control-color" id="exampleColorInput" value="{{ $attribute->value }}" title="Choose your size">
                                @endif
                              </div>
                              @error('value')
                                <div class="alert-input_field">
