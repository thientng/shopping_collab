      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="card card-primary card-outline">
            <form action="{{ route('users.update', ['id' => $user->id]) }}" method="post" enctype="multipart/form-data"> {{-- cập nhật enctype="multipart/form-data" để có thể up được nhiều ảnh một lúc --}}
              @csrf
                        ...
                        <div class="post-content">
                            <div class="post-title">
                                <div class="form-group">
                                    ...
                                    <input value="{{ $user->name }}" name = "name" type="text" class="form-control @error('name') is-invalid @enderror" id="" placeholder="Nhập tên user ...">
                                </div>
                                @error('name')
                            ...
                            <div class="post-email">
                                <div class="form-group">
                                    ...
                                    <input value="{{ $user->email }}" name = "email" type="email" class="form-control @error('email') is-invalid @enderror" id="" placeholder="Nhập tên user ...">
                                </div>
                                @error('email')
                                    <div class="alert-input_field">
                                    {{ $message }} * 
                            ...
                            <div class="post-password_repet">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('password') }}" name = "confirm_password" type="password" class="form-control @error('confirm_password') is-invalid @enderror" id="" placeholder="Nhập tên user ...">
                                </div>
                    ...
                    <div class="col-md-4 ">
                        <div class="postbox-side py-4" >
                            <div class="buttonSubmit-box d-flex justify-content-center">
                                <input type="submit" class="btn btn-primary" value="cập nhật user">
                            </div>
                        </div>
                    </div>
