  ...
  <!-- Main content -->
    <div class="content">
        <div class="container-fluid">
            <form action="{{ route('roles.update',['id' => $role->id]) }}" method="post" enctype="multipart/form-data"> {{-- Cập nhật enctype="multipart/form-data" để có thể up được nhiều ảnh một lúc --}}
                <div class="row">
                    <!-- /.col-md-12 -->
                    <div class="col-lg-12">
                                        ...
                                        <div class="post-content">
                                            <div class="post-title">
                                                <div class="form-group">
                                                    <label for="formControlInput1">Tên role</label>
                                                    <input value="{{ $role->name }}" name = "name" type="text" class="form-control @error('name') is-invalid @enderror" id="formControlInput1" placeholder="Nhập tên role ...">
                                                </div>
                                                @error('name')
                                            ...
                                            <div class="post-description pt-3">
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="8" name="display_name" class="form-control tiny-editor @error('contents') is-invalid @enderror">{{ $role->display_name }}</textarea>
                                                </div>
                                                @error('contents')
                                                    <div class="alert-input_field">
                                                    {{ $message }} * 
                                    ...
                                    <div class="col-md-4 ">
                                        <div class="postbox-side py-4" >
                                            <div class="buttonSubmit-box d-flex justify-content-center">
                                                <input type="submit" class="btn btn-primary" value="Cập nhật role">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            @foreach ($valueParent->permissionsChildrent as $valueChild)
                                                <div class="col-md-3">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" {{ $permissionsChecked->contains('id',$valueChild['id']) ? 'checked' : '' }} name="permission_id[]" value="{{ $valueChild['id'] }}" class="custom-control-input checkbox_childrent" id="customSwitch{{ $valueChild['id'] }}">
