      ...
      <div class="row justify-content-center">
        ...
        <div class="col-lg-6">
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                <form action="{{ route('menus.update', [ 'id' => $menu['id'] ]) }}" method="post"> {{-- lấy id gửi cho route mới(route update) để xử lí dữ liệu trong form--}}
                    @csrf {{-- thêm vào mỗi khi dùng form để bảo mật--}}

                    <!-- Name input -->
                    <div class="form-outline mb-4">
                      <input value="{{ $menu['name'] }}" type="text" name = "category_name" id="form4Example1" class="form-control" />
