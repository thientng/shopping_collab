      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="card card-primary card-outline">
            <form action="{{ route('slider.store') }}" method="post" enctype="multipart/form-data"> {{-- thêm enctype="multipart/form-data" để có thể up được nhiều ảnh một lúc --}}
              @csrf
                        ...
                        <div class="post-content">
                            <div class="post-title">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('name') }}" name = "name" type="text" class="form-control @error('name') is-invalid @enderror" id="formControlInput1" placeholder="Nhập tên slider ...">
                                </div>
                                @error('name')
