      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="card card-primary card-outline">
            <form action="{{ route('settings.store') }}" method="POST" "> {{-- thêm enctype="multipart/form-data" để có thể up được nhiều ảnh một lúc --}}
              @csrf
                        ...
                        <div class="post-content">
                            <div class="post-title">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('name') }}" name = "config_key" type="text" class="form-control @error('config_key') is-invalid @enderror" id="formControlInput1" placeholder="Nhập tên setting ...">
                                </div>
                                @error('config_key')
                            ...
                            <div class="post-description pt-3">
                                <div class="form-group">
                                    ...
                                    <textarea rows="8" name="config_value" class="form-control tiny-editor @error('config_value') is-invalid @enderror">{{ old('config_value') }}</textarea>
                                    @elseif(request()->type === "Text")
                                    <input type="text" name="config_value" class="form-control @error('config_value') is-invalid @enderror" value="{{ old('config_value') }}">
                                    @endif
                    ...
                    <div class="col-md-4 ">
                        <div class="postbox-side py-4" >
                            <div class="buttonSubmit-box d-flex justify-content-center">
                                <input type="submit" class="btn btn-primary" value="Thêm setting">
                            </div>
                        </div>
                    </div>
