                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            Chào {{ $guest->name }} bạn đã đăng kí tài khoản mới ở trang web của chúng tôi, xin vui lòng xác nhận tài khoản để kích hoạt tài khoản {{ $guest->email }} thành công!. Xin cảm ơn.
                                        </p>
                                        <a href="{{ route('customer.active',['id' => $guest->id, 'token' => $guest->token]) }}"
