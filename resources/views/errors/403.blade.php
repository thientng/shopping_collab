...
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
  ...
  <g>
    ...
    <text opacity="0.6" x="20" y="257" fill="#000" font-family="Viga" font-size="25">You do not have access
      <tspan x="22" y="292" >to let you pass through!</tspan>
      <tspan x="100" y="357" fill="#000" font-size="65">403</tspan>
      <tspan x="93" y="381.2" fill="#000" font-size="15">Access Forbidden.</tspan>
    </text>

    <text x="20" y="255" fill="#6BA184" font-family="Viga" font-size="25">You do not have access
      <tspan x="22" y="290" >to let you pass through!</tspan>
...
<div class="btn-box" style="display: flex;justify-content: center;margin-top:40px;">
    <!-- HTML !-->
<button class="button-54" onclick="goBack()" role="button">GO BACK</button>
<style>
    /* CSS */
.button-54 {
